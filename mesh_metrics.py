...
if __name__ == '__main__':
    gt_mesh_name = 'out_meshes/room0/gt_cropped_culled_transformed.ply'
    ours_mesh_name = 'out_meshes/room0/neus_cropped_culled_transformed.ply'

    gt_mesh = trimesh.load_mesh(gt_mesh_name)
    # neuralrgbd_mesh = trimesh.load_mesh(neuralrgbd_mesh_name)
    ours_mesh = trimesh.load(ours_mesh_name)

    # iou1, target_mesh, pred_mesh = compute_iou(neuralrgbd_mesh, gt_mesh)
    # iou2, target_mesh, pred_mesh = compute_iou(ours_mesh, gt_mesh)
    # print(iou1)
    # print(iou2)

    # ret = compute_metrics(neuralrgbd_mesh, gt_mesh)
    # print(ret)
    ret = compute_metrics(ours_mesh, gt_mesh)
    print(ret)
